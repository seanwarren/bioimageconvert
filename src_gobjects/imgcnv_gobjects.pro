...
# run: qmake imgcnv_gobjects.pro in order to generate Makefile for your platform
# Copyright (c) 2005-2010, Bio-Image Informatic Center, UCSB
#
# To generate Makefile on any platform:
#   qmake imgcnv_gobjects.pro
#
# To generate VisualStudio project file:
#   qmake -t vcapp -spec win32-msvc2005 imgcnv_gobjects.pro
#   qmake -t vcapp -spec win32-msvc.net imgcnv_gobjects.pro
#   qmake -t vcapp -spec win32-msvc imgcnv_gobjects.pro
#   qmake -spec win32-icc imgcnv_gobjects.pro # to use pure Intel Compiler
#
# To generate xcode project file:
#   qmake -spec macx-xcode imgcnv_gobjects.pro 
#
# To generate Makefile on MacOSX with binary install:
#   qmake -spec macx-g++ imgcnv_gobjects.pro
#
######################################################################
...
#---------------------------------------------------------------------
APP_NAME = imgcnv_gobjects
TARGET = imgcnv_gobjects
...
HEADERS += $$DN_SRC/gobjects.h\
           $$DN_SRC/gobjects_render_qt.h\
           $$DN_SRC/gobjects_masks.h

SOURCES += $$DN_SRC/main_gobjects.cpp\
           $$DN_SRC/gobjects.cpp\
           $$DN_SRC/gobjects_render_qt.cpp\
           $$DN_SRC/gobjects_masks.cpp
