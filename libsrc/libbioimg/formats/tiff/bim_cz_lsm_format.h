...
#define RECORDING_ENTRY_USER         0x010000047

#define DATACHANNEL_ENTRY_NAME     0xD0000001
#define DATACHANNEL_ENTRY_DYE_NAME 0x0d0000014
#define DATACHANNEL_ENTRY_SPECTRUM 0x0d0000016

#define DETCHANNEL_ENTRY_DETECTOR_GAIN        0x070000003
#define DETCHANNEL_ENTRY_AMPLIFIER_GAIN       0x070000005
#define DETCHANNEL_ENTRY_AMPLIFIER_OFFS       0x070000007
#define DETCHANNEL_ENTRY_PINHOLE_DIAMETER     0x070000009
#define DETCHANNEL_FILTER_NAME                0x070000010
#define DETCHANNEL_FILTER_SET_NAME            0x07000000f
#define DETCHANNEL_DETECTION_CHANNEL_NAME     0x70000014
#define DETCHANNEL_ENTRY_SPI_WAVELENGTH_START 0x070000022
#define DETCHANNEL_ENTRY_SPI_WAVELENGTH_END   0x070000023
#define DETCHANNEL_ENTRY_DYE_NAME             0x070000026

#define ILLUMCHANNEL_ENTRY_POWER      0x090000002
...
// LsmDataChannel
//----------------------------------------------------------------------------
class LsmDataChannel {
public:
    //LsmDataChannel(): id(-1) {};
    LsmDataChannel(int _id, int _track, const std::string &_path ) : id(_id), track(_track), path(_path) {};

    int id;
    int track;
    bim::xstring path;
    bim::xstring name;
    bim::xstring path_detection_channel;
    bim::xstring path_illumination_channel;
};
...
public:
    ...
    std::vector<LsmDataChannel> data_channels;
    std::vector<xstring> detection_channels;
    std::vector<xstring> illumination_channels;
