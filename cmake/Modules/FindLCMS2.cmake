...
find_library(LCMS2_LIBRARIES_DEBUG NAMES lcms2d liblcms2d lcms-2d liblcms-2d
   PATHS     
   ${PC_LCMS2_LIBDIR}
   ${PC_LCMS2_LIBRARY_DIRS}
   PATH_SUFFIXES lcms2
...
IF(EXISTS "${LCMS2_LIBRARIES_DEBUG}")
    set(LCMS2_LIBRARIES optimized;${LCMS2_LIBRARIES};debug;${LCMS2_LIBRARIES_DEBUG})
ENDIF()
