...
if(TIFF_FOUND)
    ...
    if(len EQUAL 1)
        ...
        get_filename_component(TIFF_LIBRARY_PATH ${TIFF_LIBRARIES} DIRECTORY)
        get_filename_component(TIFF_LIBRARY_EXTENSION ${TIFF_LIBRARIES} EXT)
        ...
        if(NOT EXISTS ${CPP_TIFF_LIBRARY})
            ...
            message("-- Found TIFF/C++: ${CPP_TIFF_LIBRARY}")
        endif()
